...
sqlite_orm::internal::storage_t<
    sqlite_orm::internal::table_t<
        ...
        sqlite_orm::internal::column_t<std::string Client::*, sqlite_orm::internal::empty_setter, sqlite_orm::internal::unique_t<>>,
        ...
        sqlite_orm::internal::foreign_key_t<std::tuple<unsigned int Client::*>, std::tuple<unsigned int FuelQuote::*>>
    >,
    sqlite_orm::internal::table_t<
        ...
        sqlite_orm::internal::column_t<double FuelQuote::*, sqlite_orm::internal::empty_setter>,
        sqlite_orm::internal::foreign_key_t<std::tuple<unsigned int FuelQuote::*>, std::tuple<unsigned int Client::*>>
    >
>
Storage;
